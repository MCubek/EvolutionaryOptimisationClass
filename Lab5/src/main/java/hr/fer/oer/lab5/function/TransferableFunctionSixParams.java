...
public class TransferableFunctionSixParams implements IFunction {

    private final RealMatrix coefficients;
    private final RealVector values;

    public TransferableFunctionSixParams(RealMatrix coefficients, RealVector values) {
        this.coefficients = coefficients;
        this.values = values;
    }

    @Override
    public double errorAt(RealVector point) {
